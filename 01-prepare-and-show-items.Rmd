...
print_cat_items("ca_nfab_low", "item")
...
print_cat_items("ca_prab_low", "item")
```

### PR RELATIVE

```{r, results='asis', echo=FALSE, ca_prre_low}
print_cat_items("ca_prre_low", "item")
```

### PF ABSOLUTE

```{r, results='asis', echo=FALSE, ca_pfab_low}
print_cat_items("ca_pfab_low", "item")
```
...
print_cat_items("ca_nfab_high", "item")
```

### PR ABSOLUTE

```{r, results='asis', echo=FALSE, ca_prab_high}
print_cat_items("ca_prab_high", "item")
```

### PR RELATIVE

```{r, results='asis', echo=FALSE, ca_prre_high}
print_cat_items("ca_prre_high", "item")
```

### PF ABSOLUTE

```{r, results='asis', echo=FALSE, ca_pfab_high}
print_cat_items("ca_pfab_high", "item")
...
print_cat_items("pr_nfab_low", "item")
```

### PR ABSOLUTE

```{r, results='asis', echo=FALSE, pr_prab_low}
print_cat_items("pr_prab_low", "item")
```

### PR RELATIVE

```{r, results='asis', echo=FALSE, pr_prre_low}
print_cat_items("pr_prre_low", "item")
```

### PF ABSOLUTE

```{r, results='asis', echo=FALSE, pr_pfab_low}
print_cat_items("pr_pfab_low", "item")
```
...
print_cat_items("pr_nfab_high", "item")
```

### PR ABSOLUTE

```{r, results='asis', echo=FALSE, pr_prab_high}
print_cat_items("pr_prab_high", "item")
```

### PR RELATIVE

```{r, results='asis', echo=FALSE, pr_prre_high}
print_cat_items("pr_prre_high", "item")
```

### PF ABSOLUTE

```{r, results='asis', echo=FALSE, pr_pfab_high}
print_cat_items("pr_pfab_high", "item")
```
