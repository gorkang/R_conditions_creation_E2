...
tibble(check = "", 
       ...
       extra = c('', "After change to Slider, __Select__ Allow Text Entry on 'Write down the main factor for you:' subitem", rep("", 8), "", "After change to Slider, __Select__ Allow Text Entry on 'Write down the main factor for you:' subitem", 
                 ...
                 "After change to Slider, __Select__ Allow Text Entry on 'Write down the main factor for you:' subitem", rep("", 8), "", "", "After change to Slider, __Select__ Allow Text Entry on 'Other' subitem", 
                 "Min value 0, Max value 1 Num. of dec. 1", 
                 'Min value 0, Max value 10. Num. of dec. 1', 
                 'Min value 1, Max value 100. Num. of dec. 1', 
                 'Min value 10, Max value 100. Num. of dec. 1'
...
tibble(check = "",
       qIDs = c("ppv_q_02_01", "ppv_gi_01", 
                ...
                "fu_Q07_01", 
                "fu_Q08_01", 
                "com_Q08_01_01", "com_Q08_02_01", "com_Q08_03_01"),
       extra = c("_Embedded Data_ > _press_format_ > _Is Not Equal to_ > __pfab__ & _Embedded Data_ > _resp_type_ > _Is Not Equal to_ > __sg__", 
