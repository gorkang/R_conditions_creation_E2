...
scale_names <- read_csv("materials/Scales/scale_names.csv", col_types = "ccci")
```
...
tibble(check = "", 
       ...
       extra = c("", "", "After change to Slider, __Select__ Allow Text Entry on 'Other' subitem", "", "", "", "After change to Slider, __Select__ Allow Text Entry on 'Other' subitem", "")) %>% 
  kableME(.)
```
...
tibble(check = "",
       qIDs = paste0(this$short_name, "_", sprintf("%02d", seq(this$no_items))), 
       extra = c(rep("Content Validation -> Number", 2), "Content Validation -> Number -> min:0;max:100", rep("", 2), 
                 "Content Validation -> Number -> min:0;max:100", "Content Validation -> Number", rep("Content Validation -> Number", 2), "Content Validation -> Number -> min:0;max:100",
