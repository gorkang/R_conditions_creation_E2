...
tibble(check = "", 
       qIDs = c("will_Q02_01", paste0("com_Q", sprintf("%02d", 1:8),"_01"), 
                "fu_Q02_01", "fu_Q03_01", "fu_Q05_01", "fu_Q06_01", "will_Q02_02", paste0("com_Q", sprintf("%02d", 1:8),"_02"), "fu_Q02_02", "fu_Q03_02", "fu_Q05_02", "fu_Q06_02"),
...
tibble(check = "",
       ...
       extra = c("[For each alternative] Custom validation -> Is greater than or equal to 1 & Is less than or equal to 4", '')) %>% 
  kableME(.)
