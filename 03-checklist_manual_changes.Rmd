...
tibble(check = "", 
       qIDs = c("will_Q02_01", paste0("com_Q", sprintf("%02d", 1:8),"_01"), 
                "fu_Q02_01", "fu_Q03_01", "fu_Q05_01", "will_Q02_02", paste0("com_Q", sprintf("%02d", 1:8),"_02"), 
                "fu_Q02_02", "fu_Q03_02", "fu_Q05_02"),
       extra = c("", rep("", 8), "", "After change to Slider, __Select__ Allow Text Entry on 'Other' subitem", "", "", rep("", 8), "", "After change to Slider, __Select__ Allow Text Entry on 'Other' subitem", "")) %>% 
  kableME(.)
```
...
tibble(check = "",
       qIDs = c("ppv_gi_01", "ppv_gs_01", "ppv_sg01_01", "ppv_sg02_01", "ppv_sg03_01", "ppv_sg04_01", "ppv_ss01_01", "ppv_ss02_01", "fu_Q05_01 (1st slider)", "fu_Q05_01 (2nd slider)"),
...
_Willing to screen 01_

```{r, echo=FALSE}
tibble(check = "",
       qIDs = paste0("will_Q", sprintf("%02d", 2:3), "_01"),
       extra = c("_Question_ > will_Q01_01 > Yes > Is selected", "_Question_ > will_Q01_01 > No > Is selected")) %>% 
  kableME(.)
```
...
```{r, echo=FALSE}
tibble(check = "",
       qIDs = paste0("fu_Q", sprintf("%02d", 2:3), "_01"),
       extra = c("_Question_ > fu_Q01_01 > Yes > Is selected", "_Question_ > fu_Q01_01 > No > Is selected")) %>% 
  kableME(.)
```
...
tibble(check = "",
       qIDs = c("ppv_gi_02", "ppv_gs_02", "ppv_sg01_02", "ppv_sg02_02", "ppv_sg03_02", "ppv_sg04_02", "ppv_ss01_02", "ppv_ss02_02", "fu_Q05_02 (1st slider)", "fu_Q05_02 (2nd slider)"),
...
_Willing to screen 02_

```{r, echo=FALSE}
tibble(check = "",
       qIDs = paste0("will_Q", sprintf("%02d", 2:3), "_02"),
       extra = c("_Question_ > will_Q01_02 > Yes > Is selected", "_Question_ > will_Q01_02 > No > Is selected")) %>% 
  kableME(.)
```
...
```{r, echo=FALSE}
tibble(check = "",
       qIDs = paste0("fu_Q", sprintf("%02d", 2:3), "_02"),
       extra = c("_Question_ > fu_Q01_02 > Yes > Is selected", "_Question_ > fu_Q01_02 > No > Is selected")) %>% 
  kableME(.)
```
