...
tibble(check = "", 
       qIDs = c("will_Q02_01", paste0("com_Q", sprintf("%02d", 1:8),"_01"), 
                "fu_Q02_01", "fu_Q03_01", "fu_Q04_01", "fu_Q06_01", "fu_Q07_01", paste0("sevEmo_0", 1:6, "_01"), "will_Q02_02", paste0("com_Q", sprintf("%02d", 1:8),"_02"), 
                "fu_Q02_02", "fu_Q03_02", "fu_Q04_02", "fu_Q06_02", "fu_Q07_02", paste0("sevEmo_0", 1:6, "_01")),
       extra = c("", rep("", 8), "", "", "After change to Slider, __Select__ Allow Text Entry on 'Other' subitem", "", "Change max value to 10, and decimals to 1", rep("", 6), "", rep("", 8), "", "", "After change to Slider, __Select__ Allow Text Entry on 'Other' subitem", "", "Change max value to 10, and decimals to 1", rep("", 6))) %>% 
  kableME(.)
```
